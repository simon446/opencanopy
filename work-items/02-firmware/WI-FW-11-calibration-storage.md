...
- [ ] NVS/flash schema for the §9.9 JSON: `moisture_raw_dry/wet`, `pump_ml_per_sec`, `fan_min_pwm`,
      `led_ppfd_map`, `reservoir_low_adc`.
...
- [ ] Unit tests for defaults, missing, and corrupt calibration (spec §10.2 "NVS config").
