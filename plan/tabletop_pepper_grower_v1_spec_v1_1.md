...
Use **two units in parallel (n=2)**, each with a Carolina Reaper or similar hot pepper (project
decision 2026-06-13, per §23 DR-03 — strengthens the gate beyond a single n=1 trial).
